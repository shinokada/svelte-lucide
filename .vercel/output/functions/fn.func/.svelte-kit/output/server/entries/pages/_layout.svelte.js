...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(MetaTags, "MetaTags").$$render(
    ...
    {},
    {}
  )} <header class="flex-none w-full mx-auto bg-white dark:bg-red-950">${validate_component(Navbar, "Navbar").$$render(
    $$result,
    {
      color: "default",
      fluid: true,
      class: "dark:bg-red-950 "
    },
    {},
    {
          ...
          {},
          {
            default: () => {
              return `${validate_component(NavLi, "NavLi").$$render(
                ...
                {
                  class: "lg:px-2 lg:mb-0",
                  href: "https://github.com/shinokada/svelte-lucide"
                },
                {},
                {
                  default: () => {
        ...
        return `<div class="sm:flex sm:items-center sm:justify-between">${validate_component(FooterBrand, "FooterBrand").$$render(
          ...
          {},
          {
            default: () => {
              return `${validate_component(FooterLink, "FooterLink").$$render($$result, { href: "/" }, {}, {
              ...
              })} ${validate_component(FooterLink, "FooterLink").$$render($$result, { href: "/icons" }, {}, {
                default: () => {
                  return `Icons`;
                }
                ...
                $$result,
                {
                  href: "https://github.com/shinokada/svelte-lucide/blob/main/LICENSE"
                },
                {},
                {
                  default: () => {
