<script lang="ts">
  ...
  const license: LicensePropsType = {
    ...
    github_repo: 'svelte-lucide',
    link: [
      'https://github.com/shinokada/svelte-lucide/blob/master/LICENSE',
      'https://github.com/shinokada/svelte-lucide/blob/master/LICENSE'
    ]
  };
...
<h1>Getting Started - Svelte Lucide v1</h1>
...
<p>Install Svelte and Svelte Lucide:</p>
