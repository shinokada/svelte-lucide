...
<MetaTags
  ...
  openGraph={{
    ...
    images: [
      {
        url: 'https://open-graph-vercel.vercel.app/api/svelte-lucide',
        width: 1200,
        height: 630,
        alt: 'Svelte Lucide'
      }
    ],
    siteName: 'Svelte Lucide'
  }}
  twitter={{
    handle: '@shinokada',
...
<div class="max-h-screen overflow-auto relative w-full" id="svelte">
  <header
    class="sticky top-0 z-40 flex-none w-full mx-auto bg-white border-b border-gray-200 dark:border-gray-600 dark:bg-red-950"
  >
