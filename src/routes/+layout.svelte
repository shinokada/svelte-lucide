...
<MetaTags
  title="{title}"
  description="Lucide icon set for Svelte"
  openGraph={{
    type: 'website',
    url: 'https://svelte-lucide.vercel.app/',
    title: "Svelte Lucide",
    description: "Lucide icon set for Svelte",
    images: [{ url: 'https://open-graph-vercel.vercel.app/api/svelte-lucide', width: 1200, height: 630, alt: "Svelte Lucide" }],
    site_name: 'Svelte Lucide'
  }}
  twitter={{
    handle: '@shinokada',
    ...
    title: "Svelte Lucide",
    description: "Lucide icon set for Svelte",
    image:'https://open-graph-vercel.vercel.app/api/svelte-lucide',
    imageAlt: "Svelte Lucide"
  }} />
  
<header class="flex-none w-full mx-auto bg-white dark:bg-red-950">
  <Navbar color="default" fluid let:hidden let:toggle class="dark:bg-red-950 ">
    <NavBrand href="/">
    ...
    <NavUl {hidden} {divClass} {ulClass} on:click={() => setTimeout(toggle, 1)} 
      ...
      <NavLi class="lg:px-2 lg:mb-0" href="https://github.com/shinokada/svelte-lucide">GitHub</NavLi>
...
<Footer footerType="logo" class="dark:bg-red-950">
  ...
  <FooterLinkGroup ulClass="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
    ...
    <FooterLink href="https://github.com/shinokada/svelte-lucide/blob/main/LICENSE">Licensing</FooterLink>
    <FooterLink href="https://github.com/shinokada/svelte-lucide/">GitHub</FooterLink>
  </FooterLinkGroup>
  </div>
</Footer>
